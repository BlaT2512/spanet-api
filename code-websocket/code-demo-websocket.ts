...
// To run this code, run the command 'npx ts-node code-demo-websocket.ts' from the command line in the same directory as this file
...
// Your spa IP, member ID and socket ID can be found by running the code-demo-request.ts script and reading the output
